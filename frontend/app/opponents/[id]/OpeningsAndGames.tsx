      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-100">
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wide">Opening</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wide">G</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wide">W–D–L</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wide">Win%</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wide">Avg CPL</th>
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wide">Blunders</th>
          </tr>
        </thead>
              ...
              >
                <td className="px-4 py-3 max-w-xs">
                  <div className="flex items-start gap-2">
                    {row.eco && (
                      <span className={`mt-0.5 shrink-0 rounded px-1.5 py-0.5 font-mono text-xs ${
    ...
    <>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">As White</span>
            </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-gray-500 uppercase tracking-wide">As Black</span>
            </div>
      ...
      <section id="games-section" className="space-y-3">
        ...
        <GamesTable
          ...
          onClearFilter={() => { setFilterEco(null); setFilterColor(null); setFilterLabel(null); }}
        />
      </section>
    </>
  );
